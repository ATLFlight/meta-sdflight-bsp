...
PROVIDES = "perf-bootimg"
DEPENDS += "virtual/kernel"

FILESPATH =+ "${WORKSPACE}/oe-core/meta-qr-linux/meta-eagle8074/recipes-kernel/linux/linux-qr-eagle8074-perf:${WORKSPACE}:${WORKSPACE}/oe-core/meta-qr-linux/meta-eagle8074/recipes-kernel/linux/linux-qr-eagle8074:"
SRC_URI = "file://linux"
...
# Avoid to handle ${DL_DIR}/linux-v4.2.6 in parallel
do_override_bluetooth_files[depends] += "virtual/kernel:do_override_bluetooth_files"
...
#do_populate_sysroot_setscene[noexec] = "1"
do_deploy[noexec] = "1"
do_deploy_setscene[noexec] = "1"
do_package[noexec] = "1"
do_package_setscene[noexec] = "1"
do_package_write_deb[noexec] = "1"
do_package_write_deb_setscene[noexec] = "1"
do_packagedata[noexec] = "1"
do_packagedata_setscene[noexec] = "1"
do_populate_sysroot() {
    echo "perf-bootimg:populate_sysroot"
}
do_populate_sysroot_setscene() {
}

do_lk_mkimage[dirs] += "${DEPLOYDIR}"
addtask lk_mkimage after do_install and before do_populate_sysroot
