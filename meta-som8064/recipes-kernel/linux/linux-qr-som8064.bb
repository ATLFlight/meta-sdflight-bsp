...
KTAG_${MACHINE} = "AU_LINUX_ANDROID_KK_2.7_RB1.04.04.02.007.041" 
...
COMPATIBLE_MACHINE_som8064-revB = "som8064-revB"
COMPATIBLE_MACHINE_som8064-const = "som8064-const"
LINUX_VERSION_EXTENSION_${MACHINE} = "-${MACHINE}"
